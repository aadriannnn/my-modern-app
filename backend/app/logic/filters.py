...
def save_menu_data_to_db(session: Session, menu_data, materii_map, obiecte_map):
    ...
    if not menu_cache:
        menu_cache = FiltreCacheMenu(id=1)

    menu_cache.menu_data = menu_data
    menu_cache.materii_map = materii_map
    menu_cache.obiecte_map = obiecte_map
