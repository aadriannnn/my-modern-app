    ...
    for row in rows:
        ...
        data = {
            ...
            **obj,
            ...
            "situatia_de_fapt": obj.get('text_situatia_de_fapt') or obj.get('situatia_de_fapt') or obj.get('situatia_de_fapt_full') or obj.get('text_fapt') or obj.get('fapt') or "",
...
def _search_by_keywords_postgres(session: Session, req: SearchRequest) -> List[Dict]:
    ...
    long_text_expr = """
        COALESCE(
          ...
          NULLIF(b.obj->>'situatia_de_fapt_full',''),
          NULLIF(b.obj->>'text_fapt',''),
          b.obj->>'fapt'
        )
    """
