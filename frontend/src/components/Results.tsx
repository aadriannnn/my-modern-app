...
type ViewType = 'situatia_de_fapt_full' | 'argumente_instanta' | 'text_individualizare' | 'cereri_accesorii';
          ...
          <div className="flex items-center space-x-2 overflow-x-auto pb-2">
            ...
            {viewOptions.map((option) => (
              <button
                ...
                className={`flex-shrink-0 px-3 py-1.5 text-xs font-semibold rounded-lg transition-colors ${activeView === option.key
