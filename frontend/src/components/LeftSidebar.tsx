...
import { ChevronDown, X, PlusCircle, ChevronsLeft, ChevronsRight } from 'lucide-react';
    ...
    const sidebarContent = (
        <div className="p-4 space-y-6 flex flex-col h-full relative">
            <button
                ...
                className="absolute top-1/2 -right-3 transform -translate-y-1/2 bg-gray-200 hover:bg-brand-accent text-gray-600 hover:text-white rounded-full p-1 z-10 hidden md:block"
